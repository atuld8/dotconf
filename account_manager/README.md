...
cat fi_list.txt | python3 -m account_manager.cli validate-fi --fi=-  # FIs from stdin
...
cat incidents.txt | python3 -m account_manager.cli validate-fi --incident=-  # Incidents from stdin
