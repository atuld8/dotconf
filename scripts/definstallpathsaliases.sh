...
function af.bld.request_handler() {
    if [ "$1" == "LAUNCH" -o "$1" == "ECHO" -o "$1" == "SJA" ]; then
        ...
        if [ "$OSName" == "SunOS" -o "$OSName" == "Darwin" ]; then
            ...
            declare bldids=([83]=0102 [8301]=0042 [8302]=0026 [90]=0053 [9001]=0030 [91]=0043 [9101]=0040 [10]=0070 [10001]=0054 [101]=0048 [1011]=0116 [102]=0065 [10201]=0037 [103]=0062 [10301]=0042 [104]=0064 [1041]=)
        else
            declare -A versions=([83]=8.3 [8301]=8.3.0.1 [8302]=8.3.0.2 [90]=9.0 [9001]=9.0.0.1 [91]=9.1 [9101]=9.1.0.1 [912]=9.1.2 [10]=10.0 [10001]=10.0.0.1 [101]=10.1 [1011]=10.1.1 [102]=10.2 [10201]=10.2.0.1 [103]=10.3 [10301]=10.3.0.1 [104]=10.4 [10401]=10.4.0.1 [105]=10.5 [10501]=10.5.0.1 [1051]=10.5.1)
            declare -A bldids=([83]=0102 [8301]=0042 [8302]=0026 [90]=0053 [9001]=0030 [91]=0043 [9101]=0040 [10]=0070 [10001]=0054 [101]=0048 [1011]=0116 [102]=0037 [1021]=0116 [102]=0065 [10201]=0037 [103]=0062 [10301]=0042 [104]=0064 [10401]=0032 [105]=0067 [10501]=0042 [1051]=)
        fi
