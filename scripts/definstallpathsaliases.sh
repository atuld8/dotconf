...
function af.bld.request_handler() {
    if [ "$1" == "LAUNCH" -o "$1" == "ECHO" -o "$1" == "SJA" ]; then
        ...
        if [ "$OSName" == "SunOS" -o "$OSName" == "Darwin" ]; then
            ...
            declare -A bldids=([83]=0102 [8301]=0042 [8302]=0026 [90]=0053 [9001]=0030 [91]=0043 [9101]=0040 [10]=0070 [10001]=0054 [101]=0048 [1011]=0116 [102]=0037 [1021]=0116 [102]=0065 [10201]=0037 [103]=0062 [10301]=0042 [104]=0064 [10401]= [1041]=)
        fi
