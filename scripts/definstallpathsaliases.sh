...
function af.bld.request_handler() {
    if [ "$1" == "LAUNCH" -o "$1" == "ECHO" -o "$1" == "SJA" ]; then
        ...
        if [ "$OSName" == "SunOS" -o "$OSName" == "Darwin" ]; then
            declare versions=([80]=8.0 [81]=8.1 [811]=8.1.1 [812]=8.1.2 [8121]=8.1.2.1 [82]=8.2 [83]=8.3 [8301]=8.3.0.1 [8302]=8.3.0.2 [90]=9.0 [9001]=9.0.0.1 [91]=9.1 [9101]=9.1.0.1 [10]=10.0 [10001]=10.0.0.1 [101]=10.1 [1011]=10.1.1)
            declare bldids=([80]=0165 [81]=0049 [811]=0103 [812]=0106 [8121]=0106 [82]=0149 [83]=0102 [8301]=0042 [8302]=0026 [90]=0053 [9001]=0030 [91]=0043 [9101]=0040 [10]=0070 [10001]=0054 [101]=0048 [1011]=0116 [102]=0065 [10201]= [1021]=)
        else
            declare -A versions=([80]=8.0 [81]=8.1 [811]=8.1.1 [812]=8.1.2 [8121]=8.1.2.1 [82]=8.2 [83]=8.3 [8301]=8.3.0.1 [8302]=8.3.0.2 [90]=9.0 [9001]=9.0.0.1 [91]=9.1 [9101]=9.1.0.1 [912]=9.1.2 [10]=10.0 [10001]=10.0.0.1 [101]=10.1 [1011]=10.1.1 [102]=10.2 [1021]=10.2.1)
            declare -A bldids=([80]=0165 [81]=0049 [811]=0103 [812]=0106 [8121]=0106 [82]=0149 [83]=0102 [8301]=0042 [8302]=0026 [90]=0053 [9001]=0030 [91]=0043 [9101]=0040 [10]=0070 [10001]=0054 [101]=0048 [1011]=0116 [102]=0037 [1021]=0116 [102]=0065 [10201]= [1021]=)
        fi
