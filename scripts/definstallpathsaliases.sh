...
function af.bld.request_handler() {
    if [ "$1" == "LAUNCH" -o "$1" == "ECHO" ]; then
        ...
        if [ "$OSName" == "SunOS" -o "$OSName" == "Darwin" ]; then
            declare versions=([80]=8.0 [81]=8.1 [811]=8.1.1 [812]=8.1.2 [8121]=8.1.2.1 [82]=8.2 [83]=8.3 [8301]=8.3.0.1)
            declare bldids=([80]=0165 [81]=0049 [811]=0103 [812]=0106 [8121]=0106 [82]=0149 [83]=0102 [8301]=0042)
        else
            declare -A versions=([80]=8.0 [81]=8.1 [811]=8.1.1 [812]=8.1.2 [8121]=8.1.2.1 [82]=8.2 [83]=8.3 [8301]=8.3.0.1)
            declare -A bldids=([80]=0165 [81]=0049 [811]=0103 [812]=0106 [8121]=0106 [82]=0149 [83]=0102 [8301]=0042)
        fi
