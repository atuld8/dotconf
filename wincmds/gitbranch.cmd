...
@IF "%GITBRANCH%" == "" (
    @IF defined ConEmuDir (
	        prompt $C$D$S$T$F$S$E[m$E[32m$E]9;8;"USERNAME"$E\@$E]9;8;"COMPUTERNAME"$E\$S$P$S$E[0m$_Cmd$S$$$S
		prompt $C$D$F$S$M[%COMPUTERNAME%]$S$P$S$_$T$SCmd$+$$$S
	) ELSE (

	    @IF defined CLINK_DIR (
		prompt $E[33m$C$D$S$T$F$S$E[32m$M$E[m$E[36m[%COMPUTERNAME%]$E[32m$S$P$S$_$E[33mCmd$+$$$S$E[0m
	     ) ELSE (
		prompt $C$D$S$T$F$S$M[%COMPUTERNAME%]$S$P$S$_Cmd$+$$$S
	    )
	)
) ELSE (
    ...
    @IF defined ConEmuDir (
		...
		prompt $C$D$S$T$F$S$E[m$E[32m$E]9;8;"USERNAME"$E\@$E]9;8;"COMPUTERNAME"$E\$S$E[92m$P$S$C$E[1;7;32;47m%FINAL_GITBRANCH%$E[0m$F$_Cmd$S$$$S
    ) ELSE (
	@IF defined CLINK_DIR (
		prompt $E[33m$C$D$S$T$F$S$E[32m$M$E[m$E[36m[%COMPUTERNAME%]$E[32m$S$P$S$E[33m$C%FINAL_GITBRANCH%$F$_$E[33mCmd$+$$$S$E[0m
	) ELSE (
		prompt $C$D$S$T$F$S$M[%COMPUTERNAME%]$S$P$S$C%FINAL_GITBRANCH%$F$_Cmd$+$$$S
        )
    )
)
