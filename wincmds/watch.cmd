...
@REM EX: cmd.watch "nbstlutil report ^& %es% ^& nbstlutil dump  -subsys 8 ^& %es% ^& nbstlutil stlilist"
@REM EX: cmd.watch tasklist ^^^| findstr SETUP
@REM EX: cmd.watch nbstlutil report
@REM EX: cmd.watch -n 10 nbstlutil report
@REM EX: cmd.watch -n 10 "nbstlutil report ^& %es% ^& nbstlutil dump  -subsys 8 ^& %es% ^& nbstlutil stlilist"
@REM EX: cmd.watch -n -1 <cmd>
@REM EX: cmd.watch -c # <cmd>
